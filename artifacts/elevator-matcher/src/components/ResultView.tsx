...
import {
  Sparkles, Bot, Shield, Cpu, UserCheck, Lock
} from "lucide-react";
...
function CTABar({ onWhatsApp }: { onWhatsApp: () => void }) {
  return (
    <div className="flex-shrink-0 flex justify-center mx-4 mb-2">
      <motion.button
        ...
        whileTap={{ scale: 0.97 }}
        onClick={onWhatsApp}
        className="flex items-center gap-2.5 px-8 py-3 rounded-2xl font-bold text-sm w-full justify-center"
        style={{
          background: "linear-gradient(135deg, #8a6510, #c89620, #f0b830)",
          color: "#000",
          boxShadow: "0 0 30px rgba(184,150,12,0.35)",
        }}
      >
        <svg viewBox="0 0 24 24" className="w-4 h-4 fill-black flex-shrink-0">
